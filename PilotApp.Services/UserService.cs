...
using PilotApp.Domain;
using PilotApp.Domain.User;
using PilotApp.Extensions;
using PilotApp.PilotApp.Interfaces;
using PilotApp.Providers;
using PilotApp.Requests.User;
using System.Data;
...
namespace PilotApp
{
    public class UserService : IUserService
    {
        ...
        public async Task<bool> LogInTest(string email, string password, int id, string[] roles = null)
        {
            ...
            Claim fullName = new Claim("CustomClaim", "PilotApp Bootcamp");
        ...
        private IUserAuthData Get(string email, string password)
        {
            ...
            _dataProvider.ExecuteCmd(procName,
                ...
                singleRecordMapper: delegate (IDataReader reader, short set)
                {
                    ...
                    bool isValidCredentials = Crypto.Equals(password, passwordFromDb);
